...
<dt>
    <h4 class="name" id="rope"><span class="type-signature"></span>rope<span class="signature">(x, y, width, height, key, frame, <span class="optional">group</span>)</span><span class="type-signature"> &rarr; {<a href="Phaser.TileSprite.html">Phaser.TileSprite</a>}</span></h4>
